  ...
  return (
    <div className="App">
      ...
      <header className="App-header">
        ...
        <h1 className="z-10 text-4xl bg-white cursor-default text-edge-outline animate-title font-display sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text">
          Raphael Rizk
        </h1>
